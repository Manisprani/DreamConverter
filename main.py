...
print_to_log_file = True    # Whether print statements should print to a log.txt file, or in console.

### I/O ###                         # TODO to be decided by Vectorworks API
dwg_file = 'ullaoriginal.dwg'       # TODO currently not used. Vectorworks API will load chosen DWG, export it to DXF, and use the exported DXF as it's intermediary file
dxf_file = 'ullaoriginal.dxf'
svg_file = 'ullaoriginal.svg'
